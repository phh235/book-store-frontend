function Footer() {
  return (
    <footer
      className="bg-dark bg-cover mt-12"
      style={{ backgroundImage: "url(src/assets/img/patterns/pattern-2.svg)" }}
    >
          ...
          <div className="row">
            ...
            <div className="col-6 col-sm">
              ...
              <ul className="list-unstyled mb-7 mb-sm-0">
                ...
                <li>
                  <a className="text-gray-300" data-bs-toggle="modal" href="#modalSizeChart">
                    Size Guide
                  </a>
                </li>
                <li>
      ...
      <div className="py-6">
        <div className="container">
          <div className="row">
            ...
            <div className="col-auto">
              <img className="footer-payment" src="src/assets/img/payment/mastercard.svg" alt="..." />
              <img className="footer-payment" src="src/assets/img/payment/visa.svg" alt="..." />
              <img className="footer-payment" src="src/assets/img/payment/amex.svg" alt="..." />
              <img className="footer-payment" src="src/assets/img/payment/paypal.svg" alt="..." />
              <img className="footer-payment" src="src/assets/img/payment/maestro.svg" alt="..." />
              <img className="footer-payment" src="src/assets/img/payment/klarna.svg" alt="..." />
            </div>
          </div>
        </div>
      </div>
